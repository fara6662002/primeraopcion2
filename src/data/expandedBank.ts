...
type RawQ = { id: string; q: string; o: string[]; c: number; e: string };
  ...
  quimica: {
    'Las características de los materiales': [
      ...
      },
      {
        ...
        c: 1,
        e: 'En un cambio físico no se forman nuevas sustancias; solo se alteran propiedades como la forma, el tamaño o el estado de agregación, conservando la composición química del material.',
      },
    ],
  },
};
